...
const Home = () => {
  return (
    <div className="mt-20 md:pt-20 lg:mt-0 flex flex-col md:flex-row w-full md:h-screen ">
      <div className="text_content md:w-3/5 flex flex-col justify-center align-center p-10 md:p-4 md:mt-[50px] pt-[0px] md:px-8 md:pl-[68px]">
      ...
      <div className="illustration-content md:w-2/5 p-4 flex justify-center items-center md:pt-10 md:relative md:right-[30px]">
        <img
          src={illustration}
          alt="Iliya Binoski"
